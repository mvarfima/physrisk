...
class ZarrReader:
    ...
    __S3_bucket = "physrisk-hazard-indicators-dev01"  # e.g. redhat-osc-physical-landing-647521352890 on staging
    __zarr_path = "hazard/hazard_consortium.zarr"  # e.g. hazard/hazard.zarr on staging
    ...
    def create_s3_zarr_store(cls, get_env: Callable[[str, Optional[str]], str] = get_env):
        ...
        zarr_path = get_env(cls.__zarr_path, "hazard/hazard_consortium.zarr")
