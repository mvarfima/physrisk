...
a = InventoryReader(fs = LocalFileSystem(), base_path = r'/data/static/')
a.read('hazard')
...
class Container(containers.DeclarativeContainer):
    ...
    inventory_reader = providers.Singleton(InventoryReader, fs = LocalFileSystem(), base_path = r'/data/static/')
